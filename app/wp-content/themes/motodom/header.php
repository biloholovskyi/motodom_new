...
<header class="header">
    <nav class="navigation">
      ...
      <ul id="nav" class="out">
        <li>
          <a class="click"  href="#" ><img class="nav-hover-close" src="<?php echo get_template_directory_uri() . '/media/icon/icon-motocylce.svg'; ?>" alt="icon motocylce" width="22" height="13">
          <img class="nav-hover" src="<?php echo get_template_directory_uri() . '/media/icon/icon-motocylce-hover.svg'; ?>" alt="icon motocylce" width="22" height="13">
          Каталог</a>
        </li>
        <li>
          <a href="/offers/"><img class="nav-hover-close" src="<?php echo get_template_directory_uri() . '/media/icon/icon-offer.svg'; ?>" alt="motodom" width="22" height="13">
        ...
        <li>
          <div class="burger-wrap">
            ...
            <img class="nav-hover" src="<?php echo get_template_directory_uri() . '/media/icon/icon-burger-hover.svg'; ?>" alt="icon motocylce" width="22" height="13">
    ...
    <div class="address item">
      ...
      <div class="address__wrapper">
        ...
        foreach($posts as $post){ setup_postdata($post);
          $contact_count_head++;
          ?>
          <div class="text <?php if($contact_count_head == 1) { echo 'text--active'; } ?>" data-tel="<?php the_field('contact_number'); ?>"><?php the_field('contact_address'); ?></div>
          <?php
        }
        wp_reset_postdata(); // сброс
        ?>
